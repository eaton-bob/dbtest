/*  =========================================================================
    dbtest_selftest.c - run selftests
...
static test_item_t
all_tests [] = {
    { "dbklass_test", dbklass_test_test },
    { "dbklass", dbklass_test },
    {0, 0}          //  Sentinel
};
...
{
    test_item_t *item;
    printf ("Running dbtest selftests...\n");
    for (item = all_tests; item->test; item++)
        item->test (verbose);
...
main (int argc, char **argv)
{
    ...
    for (argn = 1; argn < argc; argn++) {
        ...
        ||  streq (argv [argn], "-h")) {
            puts ("dbtest_selftest.c [options] ...");
